...
describe('Partial Fill Interface', () => {
    ...
    describe('PF-UI-02: Advanced UI features', () => {
        ...
        it('should create partial fill settings panel', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByLabelText('Default number of parts')).toBeInTheDocument();
            });
        });
    });
    ...
    describe('PF-UI-03: Error handling and validation', () => {
        it('should validate partial amounts sum to total', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('Partial amounts must sum to total')).toBeInTheDocument();
            });
        });
