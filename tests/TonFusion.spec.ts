...
describe('TonFusion', () => {
    ...
    beforeEach(async () => {
        ...
        tonFusion = blockchain.openContract(await TonFusion.fromInit(0n, 0n));
    ...
    it('should deploy', async () => {
        ...
        // blockchain and tonFusion are ready to use
    });
    ...
    it('should increase counter', async () => {
        ...
        for (let i = 0; i < increaseTimes; i++) {
            ...
            const increaseResult = await tonFusion.send(
                increaser.getSender(),
                {
                    value: toNano('0.05'),
                },
            ...
            const counterAfter = await tonFusion.getCounter();
