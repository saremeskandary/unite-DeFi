...
const NETWORKS: Network[] = [
    { id: 'ethereum', name: 'Ethereum', icon: 'eth', chainId: 1, type: 'smart_contract' },
    { id: 'polygon', name: 'Polygon', icon: 'matic', chainId: 137, type: 'smart_contract' },
    { id: 'bsc', name: 'BNB Smart Chain', icon: 'bnb', chainId: 56, type: 'smart_contract' },
    { id: 'arbitrum', name: 'Arbitrum', icon: 'arb', chainId: 42161, type: 'smart_contract' },
    { id: 'optimism', name: 'Optimism', icon: 'op', chainId: 10, type: 'smart_contract' },
    { id: 'avalanche', name: 'Avalanche', icon: 'avax', chainId: 43114, type: 'smart_contract' },
    { id: 'solana', name: 'Solana', icon: 'sol', chainId: 101, type: 'smart_contract' },
    { id: 'tron', name: 'Tron', icon: 'trx', chainId: 728126428, type: 'smart_contract' },
    { id: 'cardano', name: 'Cardano', icon: 'ada', chainId: 2001, type: 'smart_contract' },
    { id: 'bitcoin', name: 'Bitcoin', icon: 'btc', chainId: 0, type: 'simple' },
    { id: 'dogecoin', name: 'Dogecoin', icon: 'doge', chainId: 3, type: 'simple' },
    { id: 'litecoin', name: 'Litecoin', icon: 'ltc', chainId: 2, type: 'simple' },
    { id: 'gnosis', name: 'Gnosis', icon: 'gno', chainId: 100, type: 'smart_contract' },
    { id: 'linea', name: 'Linea', icon: 'linea', chainId: 59144, type: 'smart_contract' },
    { id: 'zksync', name: 'zkSync Era', icon: 'zksync', chainId: 324, type: 'smart_contract' },
]
